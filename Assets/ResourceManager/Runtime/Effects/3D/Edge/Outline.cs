...
/*public class Outline: MaterialEffectsBase
{
    public Color color;
    [Range(0,0.1f)]
    public float Width;
    ...
    public override void Execute()
    {
        ...
        foreach (var renderer in renderers)
        {
            ...
            {
                renderer.materials[i].SetFloat("_Factor", 0.02f);
        ...
        *//*if (IsExecute)
        {
            ...
            {
                materials.SetFloat("_Factor", 0.02f);
                renderer.materials[i].SetColor("_OutLineColor", Color.green);
            }
        }*//*
    }
...
public class Outline : MonoBehaviour
{
   ...
   /* public void Execute()
    {
        if (!this.GetComponent<Outline>().enabled)
            return;
        foreach (var renderer in renderers)
        {
