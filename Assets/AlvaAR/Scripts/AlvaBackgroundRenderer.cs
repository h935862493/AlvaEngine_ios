...
public class AlvaBackgroundRenderer : MonoBehaviour
{
   ...
   // private Texture _transitionImageTexture;
    ...
    private void UpdateShaderVariables()
    {
        ...
        //if (_transitionState == BackgroundTransitionState.BlackScreen || _transitionState == BackgroundTransitionState.FadingIn)
        //{
